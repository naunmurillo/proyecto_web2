...
export declare class CursoController {
    ...
    create(createCursoDto: CreateCursoDto): Promise<import("mongoose").Document<unknown, any, Curso> & Curso & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    findAll(): Promise<(import("mongoose").Document<unknown, any, Curso> & Curso & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
