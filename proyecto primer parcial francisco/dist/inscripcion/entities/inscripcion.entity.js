...
exports.InscripcionSchema = exports.Inscripcion = void 0;
...
__decorate([
    ...
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Inscripcion.prototype, "valor_cancelar", void 0);
Inscripcion = __decorate([
    (0, mongoose_1.Schema)()
], Inscripcion);
exports.Inscripcion = Inscripcion;
exports.InscripcionSchema = mongoose_1.SchemaFactory.createForClass(Inscripcion);
